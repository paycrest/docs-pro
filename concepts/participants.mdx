...
A **KYB-verified entity** that initiates either a fiat-to-stablecoin or stablecoin-to-fiat transaction.

### Characteristics

- **KYB Required**: Must complete business verification
...
A **KYB-verified participant** that supplies fiat liquidity in exchange for stablecoins or provides stablecoins in exchange for fiat.

### Characteristics

- **Liquidity Supply**: Provides fiat or crypto liquidity
- **KYB Required**: Business verification for compliance
...
A **KYB-verified entity** that coordinates the entire order routing process and ensures protocol efficiency.
