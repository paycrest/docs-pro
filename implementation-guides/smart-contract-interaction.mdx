...
Omit both and the aggregator resolves a queue itself at order creation. Entries must be **open, standard-tier** providers serving the corridor; restricted and fallback providers are rejected.
