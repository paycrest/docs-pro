---
title: "Quickstart"
description: "Get started with Paycrest Protocol in minutes - Learn how to create payment orders and integrate with the API"
---

# Quickstart Guide

Get started with Paycrest Protocol in minutes. This guide will walk you through creating your first payment order and integrating with the Paycrest API.
...
- **Test Tokens**: Use testnet tokens from public faucets
...
<Note>
  Remember to always test your integration in the sandbox environment before going live. The sandbox provides a safe environment to verify your implementation.
</Note> 