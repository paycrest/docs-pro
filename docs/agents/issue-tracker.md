...
- **Repo label:** `repo-docs-pro` (required on every ticket for this repository)
...
|--------------|-----------------|
| Bug, regression, broken docs/links | **Bug** |
| Enhancement, chore, docs update, vertical slice | **Task** |
...
Skills (`qa`, `triage`, `to-issues`): read this file before filing issues for the docs repo.

1. Set issue type: **Bug** or **Task** (see table above).
2. Set **labels:** `repo-docs-pro` (required).
